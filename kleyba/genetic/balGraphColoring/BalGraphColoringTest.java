...
public class BalGraphColoringTest
{
	...
	//fitness is higher
	private static double getMaxFitness(int[][] pop, BalGraphColoringGA graphC)
	{
		int size = pop.length;
		int index = 0;
	...
	private static int[] getBestIndividual(int[][] pop, BalGraphColoringGA graphC, int[] prevBest)
	{
		int maxI = 0;
	...
	private static boolean isCorrect(int[] individual, BalGraphColoringGA graphC, Graph g)
	{
		double fitness = 0.0;
    	int edgeCount = 0;
