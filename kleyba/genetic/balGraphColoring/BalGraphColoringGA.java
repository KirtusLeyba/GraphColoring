...
public class BalGraphColoringGA extends GeneticAlgorithm
{
    ...
    public double fitnessFunction(int[] individual)
    {
    	double fitness = 0.0;
    	int edgeCount = 0;
        double[] numPerColor = new double[numColors];
        ...
        double balance = numPerColor[0]/numNodes;
        double maxF = 1/(Math.pow(numColors,numColors));
        for(int i = 1; i < numColors; i++)
        {
            balance = (balance)*(numPerColor[i]/numNodes);
        }
