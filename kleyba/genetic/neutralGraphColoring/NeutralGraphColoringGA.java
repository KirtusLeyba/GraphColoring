...
//a graph coloring GA
public class NeutralGraphColoringGA extends GeneticAlgorithm
{
	private int numColors;
	private int numNodes;
	private Graph g;

	public NeutralGraphColoringGA(int k, double p, double m, int popSize, int numColors, int numNodes, Graph g)
    {
